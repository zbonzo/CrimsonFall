 ...
 * Ensures core movement and positioning calculations work correctly
 * 
...
describe('hexMath utilities', () => {
  ...
  describe('findHexPath', () => {
    ...
    it('should return null when no path exists', () => {
      ...
      // Simple case: goal itself is blocked as an obstacle
      // This should definitely return null since the goal is unreachable
  ...
  describe('performance', () => {
    it('should handle range calculations efficiently', () => {
      ...
      getHexesInRange(center, 5); // 91 hexes - much smaller test
